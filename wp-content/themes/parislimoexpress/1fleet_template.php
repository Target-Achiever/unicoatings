...
<section class="masthead fleet_bg text-center text-white d-flex">
        ...
        <section class="fleet_section">
            <div class="container">
			<?php 
				function show_img($car, $class){ ?>
					<div class="col-lg-6 col-md-6 col-sm-6 mx-auto text-center">          
                        <?php
					...
					<div class="col-lg-6 col-md-6 col-sm-6 mx-auto book_now_content text-justify">          
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <h5 class="text-center price_head">Airport Transfer</h5>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <h5 class="text-center price_head"><?php echo get_field('passengers_and_luggage',$car->ID);?></h5>
                                <ul class="list-unstyled text-center">
									<?php if( have_rows('transfer_place_with_price',$car->ID) ):								
									while ( have_rows('transfer_place_with_price',$car->ID) ) : the_row();
			...
			?>
               <!--List 1-->
                <div class="row fleet_list">
                    <div class="col-lg-12  book_now_content text-center">
                        <h3> <?php echo get_the_title($car->ID);?> </h3>
                    </div>
                    <?php 
					if($i % 2 != 0){
						show_img($car, 'class="wow slideInLeft"');
						show_details($car);
					}else{
						show_details($car);
						show_img($car, 'class="wow slideInRight"');
					}
					?>
